---
title: "Tutorial: Fine Tuning Llama3.1-8B"
---
...
For more details, check out our full [documentation](https://docs.luminolabs.ai/) or explore the [PyPi repo](https://pypi.org/project/lumino/) to get started.
